...
//   0x05,   0xff,		// USAGE_PAGE (Vendor)

//   0x09,   0x01,		// USAGE (Pointer)
//   0x15,   0x00,		// LOGICAL_MINIMUM (0)
//   0x25,   0x01,		// LOGICAL_MAXIMUM (1)
//   0x75,   0x01,		// REPORT_COUNT (1)
//   0x95,   0x02,		// REPORT_SIZE (2)

//   0xb1,   0x22,		// FEATURE (Data, Var, Abs, NPrf)
//   0x75,   0x06,		// REPORT_COUNT (1)
//   0x95,   0x01,		// REPORT_SIZE (1)
//   0xb1,   0x01,		// FEATURE (Cnst, Ary, Ads)
  
//   0xc0				// END_COLLECTION
// };


__ALIGN_BEGIN static uint8_t HID_GearBOX_ReportDesc[HID_MOUSE_REPORT_DESC_SIZE]  __ALIGN_END =
{
	0x05, 0x01,                    // 	USAGE_PAGE (Generic Desktop)
    0x09, 0x05,                    // 	USAGE (Game Pad)
    0xa1, 0x01,                    // 		COLLECTION (Application)
